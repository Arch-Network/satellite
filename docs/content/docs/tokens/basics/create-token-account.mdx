...
Use the `token_interface` and `associated_token` modules from the `satellite-apl`
...
[dependencies]
satellite-lang = { version = "0.32.0", features = ["init-if-needed"] }
```
...
declare_id!("29e3ad9a0a6b4b587ca7df4b189ffdbe8438457aad232be607fa121b57f75ad6");
