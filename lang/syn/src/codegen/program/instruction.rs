    ...
    let variants: Vec<proc_macro2::TokenStream> = program
        ...
        .map(|ix| {
            ...
            let impls = {
                ...
                quote! {
                    #(#ix_cfgs)*
                    impl arch_satellite_lang::Discriminator for #ix_name_camel {
                        const DISCRIMINATOR: &'static [u8] = #discriminator;
                    }
                    #(#ix_cfgs)*
                    impl arch_satellite_lang::InstructionData for #ix_name_camel {}
                    #(#ix_cfgs)*
                    impl arch_satellite_lang::Owner for #ix_name_camel {
                        fn owner() -> Pubkey {
                            ID
                        }
                    }
